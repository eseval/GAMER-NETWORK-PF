...
export default function RewardDetails() {
  ...
  return (
    <div>
      <a
        href="#"
        className="flex flex-col items-center bg-white rounded-lg border shadow-md md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 p-4 mx-4 my-4 min-w-1/2 min-h-fit-content"
      >
        <img
