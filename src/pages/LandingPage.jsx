...
export default function LandingPage() {
	...
	if (isAuthenticated) {
		while (window.localStorage.userLogged === '' || window.localStorage.userLogged === undefined) {
			return (
				<div>
					<div className="bg-[url('https://cdnb.artstation.com/p/assets/images/images/012/193/905/original/maria-hager-titlescreen-retro-glitch.gif?1533552570')] bg-cover bg-center bg-no-repeat bg-center fixed h-screen w-screen"></div>
					<div className="my-10 container text-center align-middle">
						<h1 className="text-5xl font-totifont text-white ">Play Center</h1>
		...
		return (
			<div className="bg-[url('https://cdnb.artstation.com/p/assets/images/images/012/193/905/original/maria-hager-titlescreen-retro-glitch.gif?1533552570')] bg-cover bg-center bg-no-repeat bg-center fixed h-screen w-screen">
				<div className="container text-center align-middle">
					<h1 className="text-8xl font-totifont text-white opacity-70 my-20">Play Center</h1>
					<img className="absolute inset-0 h-32 w-32" src="https://i.imgur.com/9ESFHWn.png" alt="" />
					<div className="mt-10">
						<LoginButton />
					</div>
